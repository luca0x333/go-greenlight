...
// readCSV helper reads a string value from the query string and then splits it into a slice over a comma character.
// If not matching key is found it returns the default value.
...
// readInt helper reads a string value from the query string and converts it into a integer.
// If not matching key is found it returns the default value.
// If it cannot convert it into a integer, we record the error message into the validator instance.
...
func (app *application) background(fn func()) {
	...
	go func() {
		...
		// Execute the function that we pass as parameter.
		fn()
	}()
}
